...
public:
    ...
    GuillotineBinPack(value_type width, value_type height);

	/// (Re)initializes the packer to an empty bin of width x height units. Call whenever
	/// you need to restart with a new bin.
    void Init(value_type width, value_type height);
    ...
    Rect Insert(value_type width, value_type height, bool merge, FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
...
private:
    ...
    Rect FindPositionForNewNode(value_type width, value_type height, FreeRectChoiceHeuristic rectChoice, int *nodeIndex);

    static value_type ScoreByHeuristic(value_type width, value_type height, const Rect &freeRect, FreeRectChoiceHeuristic rectChoice);
    ...
    static value_type ScoreBestAreaFit(value_type width, value_type height, const Rect &freeRect);
    static value_type ScoreBestShortSideFit(value_type width, value_type height, const Rect &freeRect);
    static value_type ScoreBestLongSideFit(value_type width, value_type height, const Rect &freeRect);

    static value_type ScoreWorstAreaFit(value_type width, value_type height, const Rect &freeRect);
    static value_type ScoreWorstShortSideFit(value_type width, value_type height, const Rect &freeRect);
    static value_type ScoreWorstLongSideFit(value_type width, value_type height, const Rect &freeRect);
