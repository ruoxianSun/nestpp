...
#ifndef QTCSSPARSER_H
#define QTCSSPARSER_H
...
#define QT_CSS_DECLARE_TYPEINFO(Class, Type) \
    ...
    Q_DECLARE_TYPEINFO(QtCss:: Class, Type); \
    namespace QtCss {
...
struct Value
{
    ...
    QTCSS_EXPORT QString toString() const;
};
...
struct QTCSS_EXPORT Declaration
{
...
struct StyleSheet
{
    ...
    QTCSS_EXPORT void buildIndexes(Qt::CaseSensitivity nameCaseSensitivity = Qt::CaseSensitive);
};
QT_CSS_DECLARE_TYPEINFO(StyleSheet, Q_MOVABLE_TYPE)


class QTCSS_EXPORT StyleSelector
{
public:
...
struct Symbol
{
    ...
    QString text;
    int start, len;
    QTCSS_EXPORT QString lexem() const;
};
QT_CSS_DECLARE_TYPEINFO(Symbol, Q_MOVABLE_TYPE)

class QTCSS_EXPORT Scanner
{
public:
...
struct QTCSS_EXPORT ValueExtractor
{
    ...
    bool extractBackground(QBrush *, QString *, Repeat *, Qt::Alignment *, QtCss::Origin *, QtCss::Attachment *,
                           QtCss::Origin *);
    bool extractGeometry(int *w, int *h, int *minw, int *minh, int *maxw, int *maxh);
    bool extractPosition(int *l, int *t, int *r, int *b, QtCss::Origin *, Qt::Alignment *,
                         QtCss::PositionMode *, Qt::Alignment *);
...
private:
    void extractFont();
    void borderValue(const Declaration &decl, int *width, QtCss::BorderStyle *style, QBrush *color);
...
Q_DECLARE_METATYPE( QtCss::BackgroundData )
Q_DECLARE_METATYPE( QtCss::LengthData )
Q_DECLARE_METATYPE( QtCss::BorderData )
